...
class CollapsibleTableViewHeader: UITableViewHeaderFooterView {
    ...
    override init(reuseIdentifier: String?) {
        ...
        //
        titleLabel.font = UIFont(name:"Chivo-Bold", size: 14.0)
    ...
    func tapHeader(_ gestureRecognizer: UITapGestureRecognizer) {
        ...
        print("Sección: \(cell.section)")
        
        /*let my = HomeViewController()
        if cell.section == 0 {
            my.performSegue(withIdentifier: "usuarioSegue", sender: self)
        }
        */
        //HomeViewController.performSegue(withIdentifier: "usuarioSegue", sender: self)
